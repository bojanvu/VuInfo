...
import com.algebra.vuinfo.data.BusStations;
import com.algebra.vuinfo.models.MapStateManager;
...
public class VuBusStopActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_vu_bus_stop);
		...
		MarkerOptions marker_radnicki_dom_borovo = new MarkerOptions()
				.icon(BitmapDescriptorFactory
						.fromResource(R.drawable.marker_crveni_48px))
				.position(RADNICKI_DOM_BOROVO).title("Radnièki dom Borovo")
				.snippet(radnicki_dom_borovo);
	...
	private void initiliazeMap() {
		if (googleMap == null) {
			googleMap = ((SupportMapFragment) getSupportFragmentManager()
					.findFragmentById(R.id.vu_bus_map)).getMap();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.vubusstop, menu);
		ActionBar actionBar = getActionBar();
		actionBar.setBackgroundDrawable(new ColorDrawable(Color
				.parseColor("#336699")));
		actionBar.setTitle("VuBusStop");
