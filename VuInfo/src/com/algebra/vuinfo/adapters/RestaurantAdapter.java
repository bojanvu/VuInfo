...
public class RestaurantAdapter extends ArrayAdapter<String> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = RestaurantData.GetbyId(id).IconFile;

		textViewName.setText(RestaurantData.GetbyId(id).Name);
		textViewAddress.setText(RestaurantData.GetbyId(id).Address);
		textViewMail.setText(RestaurantData.GetbyId(id).Mail);
		textViewPhone.setText(RestaurantData.GetbyId(id).Phone);
