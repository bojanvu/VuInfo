...
public class HotelsAdapter extends ArrayAdapter<String> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageFile = HotelsData.GetbyId(id).IconFile;

		textViewName.setText(HotelsData.GetbyId(id).Name);
		textViewAddress.setText(HotelsData.GetbyId(id).Address);
		textViewMail.setText(HotelsData.GetbyId(id).Mail);
		textViewPhone.setText(HotelsData.GetbyId(id).Phone);
